...
export default async function AdminLaporanPage({ searchParams }) {
  ...
  return (
    <>
      ...
      <div className="admin-card no-print">
        <form action="/admin/laporan" method="get" className="admin-filter-form">
          ...
          <div className="admin-filter-aksi">
            ...
            {adaFilter && (
              <Link href="/admin/laporan" className="btn btn-outline">
                Reset
              </Link>
            )}
          </div>
